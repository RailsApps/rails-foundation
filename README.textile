...
This example application uses Foundation 5.0.3.1. Foundation version 5.1.1.0 is incompatible with the Rails asset pipeline (see the "issue":https://github.com/RailsApps/rails-foundation/issues/2).
