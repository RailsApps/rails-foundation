...
Rails 4.0 example application that integrates Rails and Foundation 5.0.
...
Foundation 5.0 was released November 21, 2013. Foundation 5.0.3 was released January 15, 2014. This example application uses Rails 4.0 and Foundation 5.0.3 (or newer). Foundation versions 5.0.1 and 5.0.2 were "incompatible with Rails Turbolinks":https://github.com/zurb/foundation/issues/3642 and the Rails asset pipeline, so use 5.0.3 or newer with Rails.
